...
<?php
	...
	echo "<br><h4 style='text-align:center'>No tracking number found</h4><br>";
...
<form method="POST" action="track_result.php">
    ...
    <span class="wpcf7-form-control-wrap your-email">
    	<input type="text" name="track_number" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email" aria-required="true" aria-invalid="false" />
    					...
    					<p><input type="submit" name="track" value="Track" class="wpcf7-form-control has-spinner wpcf7-submit" /></p>
